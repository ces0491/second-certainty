...
subtitle: "Financial Software Engineering Assignment (ECO5040S)"
author: "Cesaire Tobias (TBSCES001)"
date: "August 18, 2025"
format: 
  pdf:
    toc: true
...
Traditional tax management often occurs reactively at tax submission deadlines, leading to unexpected liabilities, missed deductions, and stress. Second Certainty transforms this approach by implementing a proactive, year-round tax management system that calculates estimated tax liabilities based on real-time income and expense streams.
...
## Backend
- **Framework**: FastAPI 0.110.1 - intuitive api framework with modern Python type annotations
...
- **Database**: 
  - PostgreSQL (production) - chosen for native support in Render (for deployment)
  - SQLite (development)
- **Authentication**: JWT with HTTPBearer security and bcrypt password hashing - secure authentication approach
- **Testing**: Pytest 7.4.4 with pytest-asyncio 0.23.5 - testing framework for Python including async support
...
- **Database Migrations**: Alembic 1.13.1 - database schema management
- **Server**: Uvicorn 0.29.0 - ASGI server

## Frontend
- **Framework**: React 18.2 - project specified
- **Routing**: React Router 6.22.1 - provides declarative routing for React applications
- **HTTP Client**: Axios 1.6.7 - HTTP client for API communication
- **State Management**: React Context API - built-in state management solution that avoids external dependencies
- **Styling**: Tailwind CSS 3.4.1 - CSS framework for UI development
...
- **User Registration and Login**: User account management with profile customization
...
- **Frontend Application**: https://second-certainty.onrender.com
- **Backend API**: https://second-certainty-api.onrender.com
- **API Documentation**: https://second-certainty-api.onrender.com/api/docs
...
- **Installation Guide**: https://github.com/ces0491/second-certainty/blob/main/docs/INSTALLATION.md - Complete setup instructions for local development
- **Deployment Guide**: https://github.com/ces0491/second-certainty/blob/main/docs/DEPLOYMENT.md - Comprehensive production deployment instructions
- **API Documentation**: https://github.com/ces0491/second-certainty/blob/main/docs/API.md - Detailed API reference with examples
...
*The main dashboard showing key tax metrics and income/expense breakdown.*

## Income Tracking
![Income Tracking](./images/Income.png)
*Interface for managing multiple income sources with PAYE categorization and annual amount tracking.*

## Expense Management
![Expense Management](./images/Expenses.png)
*Expense tracking interface with predefined tax-deductible categories.*
...
*User profile interface for managing personal information, provisional taxpayer status, and account preferences.*
...
- **Error Handling**: Exception management with structured error responses
...
- **Input Sanitization**: validation at both API and database levels
- **CORS Configuration**: Secure cross-origin resource sharing with whitelisted domains

# Future Enhancements
- **Rate Limiting**: Implement rate limiting
- **Profile Deletion**: Enable safe deletion of profiles

...
## Backend
- **Framework**: FastAPI 0.110.1 - powerful, intuitive framework with modern Python type annotations
...
- **Frontend Application**: [https://second-certainty.onrender.com](https://second-certainty.onrender.com){target="_blank"}
- **Backend API**: [https://second-certainty-api.onrender.com](https://second-certainty-api.onrender.com){target="_blank"}
- **API Documentation**: [https://second-certainty-api.onrender.com/api/docs](https://second-certainty-api.onrender.com/api/docs){target="_blank"}
...
- [Installation Guide](https://github.com/ces0491/second-certainty/blob/main/docs/INSTALLATION.md){target="_blank"}: Complete setup instructions for local development
- [Deployment Guide](https://github.com/ces0491/second-certainty/blob/main/docs/DEPLOYMENT.md){target="_blank"}: Comprehensive production deployment instructions
- [API Documentation](https://github.com/ces0491/second-certainty/blob/main/docs/API.md){target="_blank"}: Detailed API reference with examples

# Code Repository

The project is maintained in two separate repositories:

- **Backend Repository**: [https://github.com/ces0491/second-certainty](https://github.com/ces0491/second-certainty){target="_blank"}
- **Frontend Repository**: [https://github.com/ces0491/second-certainty-frontend](https://github.com/ces0491/second-certainty-frontend){target="_blank"}
